 ...
 * @author User
 */
public class ALL_PRODUCT extends javax.swing.JFrame {

    /**
     * Creates new form ALL_PRODUCT
     */
    public ALL_PRODUCT() {
        initComponents();
         loadAllProducts();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       StoreMainForm back = new StoreMainForm();
       back.show();
       dispose();
...
private void refreshProductTable() {
    ...
    try {
        ...
        String currentName = rs.getString("item_name");
        ...
        // Update 
        String updateQuery = "UPDATE products SET item_name = ?, price = ?, quantity = ? WHERE id = ?";
    ...
    try {
        ...
        if (keyword.isEmpty()) {
            ...
            sql = "SELECT * FROM products WHERE CAST(id AS CHAR) LIKE ? OR LOWER(item_name) LIKE ?";
            pst = conn.prepareStatement(sql);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ALL_PRODUCT().setVisible(true);
            }
        });
    }
